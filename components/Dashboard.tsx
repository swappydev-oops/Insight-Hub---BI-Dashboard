  ...
  if (charts.length === 0) {
    return (
      ...
      >
        ...
        <h3 className="text-xl font-semibold text-gray-900 dark:text-[#f9fafb]">Let's build something great.</h3>
        <p className="text-gray-500 dark:text-[#d1d5db] mt-2">Drag a chart from the toolbox to get started!</p>
      </div>
    );
  }
